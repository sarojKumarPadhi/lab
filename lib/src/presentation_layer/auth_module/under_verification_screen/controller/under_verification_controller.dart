import 'package:zonk_rider/src/domain_layer/entities/authentication_entities/login_entities.dart';

import '../../../../../core/app_exports.dart';
import '../../../../../core/utils/enums.dart';
import '../../../../domain_layer/usecases/authentication_usecase/login_uscase.dart';

class UnderVerificationController extends GetxController {
  UnderVerificationController(this._loginUserUseCase);
